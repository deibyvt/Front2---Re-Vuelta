...
interface NavbarProps {
  ...
  onRequestLogin: (action: string) => void;
}
        ...
        <div className="flex flex-col gap-3 py-3 lg:py-0">
          <div className="flex items-center justify-between h-16 gap-4">
            <div className="flex items-center gap-3 min-w-[180px]">
              ...
              <button
                onClick={() => setCurrentTab('home')}
                className="hidden sm:inline-flex items-center justify-center rounded-full border border-emerald-700/70 bg-emerald-900/70 px-4 py-2 text-sm font-semibold text-emerald-100 hover:bg-emerald-900 transition"
              >
                Inicio
              </button>
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center justify-center gap-2 rounded-full bg-emerald-500 px-4 py-2 text-sm font-semibold text-emerald-950 hover:bg-emerald-400 transition"
              >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-emerald-800/80 bg-emerald-950 px-4 pt-3 pb-6 space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-emerald-500 text-emerald-950 px-4 py-2.5 rounded-xl text-sm font-semibold hover:bg-emerald-400 transition mb-3"
          >
